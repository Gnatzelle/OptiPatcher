...
static void CheckForPatch()
{
    ...
    // Remastered, Chernobylite 2: Exclusion Zone, Commandos: Origins, MindsEye, Frostpunk 2, Enotria: The Last Song,
    // Celestial Empire, Alien: Rogue Incursion Evolved Edition, Manor Lords, Nobody Wants to Die, Valor Mortis
    ...
    // Shift, Half Sword, I Am Jesus Christ, Star Trek: Voyager - Across the Unknown, Grounded 2, Mortal Shell 2
             ...
             CHECK_UE(imjch) || CHECK_UE(stvoyagersteam) || CHECK_UE(grounded2steam) || CHECK_UE(mortalshell2))
    {
    ...
    // High On Life 2 (+ WinGDK), Far Far West, ROUTINE, Samson, VOID/BREAKER, The Sinking City 2 Demo
    else if (CHECK_UE(highonlife2) || CHECK_UE(farfarwest) || CHECK_UE(routine) || CHECK_UE(cjsteam) ||
             CHECK_UE(voidbreaker) || exeName == "thesinkingcity2demo.exe")
    {
    ...
    // Fatekeeper, Gothic 1 Remake, Mortal Shell 2, The Sinking City 2 Demo
             ...
             CHECK_UE(g1r) || CHECK_UE(mortalshell2) || exeName == "thesinkingcity2demo.exe")
    {
        std::string_view pattern("75 ? C7 05 ? ? ? ? 02 00 00 00 B8 02 00 00 00");
        uintptr_t start = 0;
        void* patchAddress = nullptr;
